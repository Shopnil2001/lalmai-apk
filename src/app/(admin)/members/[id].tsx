          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.headerInfo}>
              ...
              <View style={styles.badges}>
                ...
                {member.carType && member.carType !== 'none' && (
                  <View style={{
                    paddingHorizontal: 8,
                    paddingVertical: 2,
                    borderRadius: 12,
                    ...
                    alignItems: 'center',
                    marginRight: 6,
                    backgroundColor: 'rgba(235, 124, 12, 0.1)',
                    borderColor: 'rgba(235, 124, 12, 0.3)',
                    borderWidth: 1
                  }}>
                    <Text style={{ fontSize: 9, fontWeight: '800', color: '#EA580C', textTransform: 'uppercase' }}>
                      {`Car Owner - ${member.carType}`}
                    </Text>
                  </View>
                )}
        ...
        <Card style={styles.detailsCard} elevation="sm">
          ...
          <View style={styles.detailItem}>
            ...
            <Text style={styles.detailVal}>
              {member.carType && member.carType !== 'none' ? `Car Owner - ${member.carType}` : 'None'}
            </Text>
          </View>

          <View style={styles.detailItem}>
            <Text style={styles.detailLabel}>Detailed Address:</Text>
            <Text style={styles.detailVal}>{member.address || 'N/A'}</Text>
          </View>
