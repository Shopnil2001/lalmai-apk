...
import { HomepageSettings, UserProfile } from '../../services/mockData';
...
export default function UserProfileScreen() {
  ...
  const [carType, setCarType] = useState<UserProfile['carType']>(user?.carType || 'none');
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      await updateProfile({ name, phone, drivingLicense: license, registrationNumber: vehicle, area, photoUrl, carType, address });
      setIsEditing(false);
      setPendingPhotoUri(undefined);
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.profileHeader, { paddingTop: insets.top + 12 }]}>
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 6 }}>
          ...
          {user.carType && user.carType !== 'none' && (
            <View style={[styles.rolePill, { backgroundColor: 'rgba(235, 124, 12, 0.25)', borderColor: 'rgba(235, 124, 12, 0.4)' }]}>
              <Text style={[styles.rolePillText, { color: '#FDBA74' }]}>{`CAR OWNER - ${user.carType.toUpperCase()}`}</Text>
            </View>
          )}
        </View>
          ...
          <View style={styles.cardBody}>
            ...
            <View style={styles.cardInfo}>
              ...
              <Text style={styles.cardRole}>
                ...
                {user.carType && user.carType !== 'none' ? ` • CAR OWNER (${user.carType.toUpperCase()})` : ''}
              </Text>
        ...
        <View style={styles.infoCard}>
          ...
          {isEditing ? (
            <View>
              ...
              {/* Car Type Selector */}
              <View style={{ marginBottom: Spacing.sm }}>
                <Text style={styles.selectorLabel}>Car Type</Text>
                <TouchableOpacity
                  activeOpacity={0.8}
                ...
                >
                  ...
                  <Ionicons name={showCarDropdown ? "chevron-up" : "chevron-down"} size={20} color={D.textSecondary} />
                </TouchableOpacity>
                  ...
                  <View style={styles.selectorDropdown}>
                    {['none', 'NOAH', 'TRX', 'Private Car'].map((c, idx) => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.selectorDropdownItem,
                          carType === c && styles.selectorDropdownItemActive
                        ]}
                      >
                        <Text style={[
                          styles.selectorDropdownText,
                          carType === c && styles.selectorDropdownTextActive
                        ]}>
              ...
              <Input label="Detailed Address" placeholder="Enter your full address" value={address} onChangeText={setAddress} />
            ...
            <View>
              ...
              <View style={styles.field}>
                ...
                <Text style={styles.fieldVal}>
                  {user.carType && user.carType !== 'none' ? `Car Owner - ${user.carType}` : 'None'}
                </Text>
              </View>
              <View style={[styles.field, { borderBottomWidth: 0 }]}>
                <Text style={styles.fieldLabel}>Detailed Address</Text>
                <Text style={styles.fieldVal}>{user.address || 'Not added'}</Text>
              </View>
            </View>
          )}
        </View>
